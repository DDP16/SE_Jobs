...
export default function HotJobTopCVSection() {
    ...
    return (
        <div id="hotjob-topcv-section" className="container mx-auto px-4 sm:px-6 md:px-8 max-w-7xl space-y-6">
            {/* Header */}
            <div className="flex justify-between items-center">
                ...
                <button
                    ...
                    onClick={() => window.open('https://job-portal.topcv.vn/uit', '_blank')}
                >
