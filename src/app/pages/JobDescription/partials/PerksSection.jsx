...
import { Heart, Umbrella, TrendingUp, Mountain, Home, Gift, DollarSign, Shield } from "lucide-react";
...
export default function PerksSection() {
  ...
  return (
    ...
    >
      <h2 className="text-2xl font-bold text-foreground mb-2">Perks & Benefits</h2>
